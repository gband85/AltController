...
namespace AltController
{
    public partial class MainWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            // {
            //     // Store update rate
            //     _uiUpdateIntervalMS = _appConfig.GetIntVal(Constants.ConfigUIUpdateIntervalMS,
            //         Constants.DefaultUIUpdateIntervalMS);
            //
            ...
            //     this.ViewDrawScreenRegions.IsChecked = _appConfig.GetBoolVal(Constants.ConfigDrawScreenRegions,
            //         Constants.DefaultDrawScreenRegions);
            //     this.ViewShowScreenRegionNames.IsChecked = _appConfig.GetBoolVal(Constants.ConfigShowScreenRegionNames,
            //         Constants.DefaultShowScreenRegionNames);
            //     this.ViewDrawPointerIndicator.IsChecked =
            //         _appConfig.GetBoolVal(Constants.ConfigDrawPointerIndicatorLine,
            //             Constants.DefaultDrawPointerIndicatorLine);
            //     this.ViewDrawStateOverlay.IsChecked = _appConfig.GetBoolVal(Constants.ConfigDrawStateOverlay,
            //         Constants.DefaultDrawStateOverlay);
            //     this.WindowShowTitleBars.IsChecked = _appConfig.GetBoolVal(Constants.ConfigCustomWindowTitleBars,
            //         Constants.DefaultCustomWindowTitleBars);
            //
        ...
        private void RegisterHotkeys()
        {
            ...
            //         {
            //             description = "\t" + (string)converter.Convert((long)hotkey, typeof(string), null,
            ...
            //             break;
            //         case Constants.ConfigShowScreenRegionNamesHotkey:
            //             ViewShowScreenRegionNames.Header =
            //                 Properties.Resources.Main_ViewDrawScreenRegionNames + description;
            //             break;
            //         case Constants.ConfigDrawPointerIndicatorLineHotkey:
            //             ViewDrawPointerIndicator.Header =
            //                 Properties.Resources.Main_ViewDrawPointerIndicator + description;
            //             break;
            //         case Constants.ConfigDrawStateOverlayHotkey:
        ...
        {
            // _hotkeys.Clear();
            // _hotkeys[Constants.ConfigDrawScreenRegionsHotkey] =
            //     (uint)_appConfig.GetIntVal(Constants.ConfigDrawScreenRegionsHotkey, 0);
            // _hotkeys[Constants.ConfigShowScreenRegionNamesHotkey] =
            //     (uint)_appConfig.GetIntVal(Constants.ConfigShowScreenRegionNamesHotkey, 0);
            // _hotkeys[Constants.ConfigDrawPointerIndicatorLineHotkey] =
            //     (uint)_appConfig.GetIntVal(Constants.ConfigDrawPointerIndicatorLineHotkey, 0);
            // _hotkeys[Constants.ConfigDrawStateOverlayHotkey] =
            //     (uint)_appConfig.GetIntVal(Constants.ConfigDrawStateOverlayHotkey, 0);
            // _hotkeys[Constants.ConfigCustomWindowTitleBarsHotkey] =
            //     (uint)_appConfig.GetIntVal(Constants.ConfigCustomWindowTitleBarsHotkey, 0);
        }
        ...
        //                 _appConfig.GetStringVal(Constants.ConfigProfilesDir, defaultProfilesFolder);
        ...
        //                 ECommandAction actionType = messageBox.Result == MessageBoxResult.Yes
        //                     ? ECommandAction.Run
        //                     : ECommandAction.DontRun;
        ...
        //         bool autoLoadLastProfile = _appConfig.GetBoolVal(Constants.ConfigAutoLoadLastProfile,
        //             Constants.DefaultAutoLoadLastProfile);
        ...
        //     ApplyNewProfile(profile);
        //     _profileChanged =
        //         false; // Set to value of 'profileUpgraded' if you wish to prompt the user to save after upgrade
        //
        //     // Auto open windows if required
        //     bool autoOpen = _appConfig.GetBoolVal(Constants.ConfigAutoOpenCustomWindows,
        //         Constants.DefaultAutoOpenCustomWindows);
        //     if (autoOpen)
        //     {
        ...
        //                     _commandBlockedMessageBox = new CustomMessageBox(this, message,
        //                         Properties.Resources.Info_CommandDisallowed, MessageBoxButton.OK, true, false);
        ...
        //                             Constants.ApplicationName, Environment.NewLine, thisCommand);
        //                         _confirmCommandMessageBox = new CustomMessageBox(this, message,
        //                             Properties.Resources.Q_RunCommand, MessageBoxButton.YesNoCancel, true, true);
